...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/app/AppCompatDialog;Landroid/view/Window;)V
    ...
    sget-object v1, Landroid/support/v7/appcompat/R$styleable;->I:[I

    sget v2, Landroid/support/v7/appcompat/R$attr;->o:I
    ...
    .line 180
    sget v1, Landroid/support/v7/appcompat/R$styleable;->M:I
...
.method public final a()V
    ...
    sget v1, Landroid/support/v7/appcompat/R$id;->p:I
    ...
    sget v4, Landroid/support/v7/appcompat/R$id;->E:I
    ...
    iput-object v1, p0, Landroid/support/v7/app/AlertController;->w:Landroid/widget/ScrollView;
    ...
    sget v5, Landroid/support/v7/appcompat/R$attr;->n:I
    ...
    invoke-static {v0}, Landroid/support/v7/app/AlertController;->a(Landroid/widget/Button;)V
    ...
    sget v1, Landroid/support/v7/appcompat/R$id;->W:I
    ...
    sget-object v6, Landroid/support/v7/appcompat/R$styleable;->I:[I

    sget v7, Landroid/support/v7/appcompat/R$attr;->o:I

    invoke-static {v1, v5, v6, v7}, Landroid/support/v7/internal/widget/TintTypedArray;->a(Landroid/content/Context;Landroid/util/AttributeSet;[II)Landroid/support/v7/internal/widget/TintTypedArray;
    ...
    .line 2479
    iget-object v6, p0, Landroid/support/v7/app/AlertController;->C:Landroid/view/View;
    ...
    sget v1, Landroid/support/v7/appcompat/R$id;->V:I
    ...
    sget v1, Landroid/support/v7/appcompat/R$id;->m:I
    ...
    sget v1, Landroid/support/v7/appcompat/R$id;->S:I
    ...
    sget v1, Landroid/support/v7/appcompat/R$id;->r:I
    ...
    invoke-static {v4}, Landroid/support/v7/app/AlertController;->c(Landroid/view/View;)Z
    ...
    sget v2, Landroid/support/v7/appcompat/R$id;->q:I
    ...
    iget v4, p0, Landroid/support/v7/app/AlertController;->j:I
    ...
    .line 1468
    :cond_8
    invoke-virtual {v5}, Landroid/support/v7/internal/widget/TintTypedArray;->b()V
    ...
    iget-object v4, p0, Landroid/support/v7/app/AlertController;->B:Landroid/widget/TextView;
    ...
    sget v1, Landroid/support/v7/appcompat/R$id;->l:I
    ...
    iget-object v7, p0, Landroid/support/v7/app/AlertController;->z:Landroid/widget/ImageView;
    ...
    sget v6, Landroid/support/v7/appcompat/R$id;->V:I
    ...
    .line 1431
    iget v4, p0, Landroid/support/v7/app/AlertController;->h:I
