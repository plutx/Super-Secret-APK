...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;ZZLjava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lkik/core/net/outgoing/x;->n:Ljava/util/List;

    .line 25
    const/4 v0, 0x0

    iput v0, p0, Lkik/core/net/outgoing/x;->o:I

    .line 31
    iput-object p1, p0, Lkik/core/net/outgoing/x;->k:Ljava/lang/String;

    .line 32
    iput-object p2, p0, Lkik/core/net/outgoing/x;->j:Ljava/lang/String;

    .line 34
    iput-boolean p3, p0, Lkik/core/net/outgoing/x;->a:Z

    .line 35
    iput-boolean p4, p0, Lkik/core/net/outgoing/x;->b:Z

    .line 37
    iput-object p5, p0, Lkik/core/net/outgoing/x;->l:Ljava/lang/String;

    .line 38
    iput-object p6, p0, Lkik/core/net/outgoing/x;->m:Ljava/lang/String;
...
.method public final a(Ljava/util/List;)V
    ...
    .line 47
    :cond_0
    iput-object p1, p0, Lkik/core/net/outgoing/x;->n:Ljava/util/List;
...
.method protected final b(Lkik/core/net/g;)V
    ...
    invoke-virtual {p0, v0}, Lkik/core/net/outgoing/x;->c(I)V
...
.method protected final b(Lkik/core/net/h;)V
    ...
    .line 88
    iget-object v0, p0, Lkik/core/net/outgoing/x;->l:Ljava/lang/String;
    ...
    iget-object v1, p0, Lkik/core/net/outgoing/x;->l:Ljava/lang/String;
    ...
    .line 91
    :cond_0
    iget-object v0, p0, Lkik/core/net/outgoing/x;->m:Ljava/lang/String;
    ...
    iget-object v1, p0, Lkik/core/net/outgoing/x;->m:Ljava/lang/String;
    ...
    .line 97
    iget-boolean v0, p0, Lkik/core/net/outgoing/x;->a:Z
    ...
    .line 101
    :cond_2
    iget-object v0, p0, Lkik/core/net/outgoing/x;->k:Ljava/lang/String;

    if-eqz v0, :cond_3

    const-string v0, ""

    iget-object v1, p0, Lkik/core/net/outgoing/x;->k:Ljava/lang/String;
    ...
    .line 104
    :cond_3
    iget-object v0, p0, Lkik/core/net/outgoing/x;->j:Ljava/lang/String;

    if-eqz v0, :cond_4

    const-string v0, ""

    iget-object v1, p0, Lkik/core/net/outgoing/x;->j:Ljava/lang/String;
    ...
    .line 110
    iget-object v0, p0, Lkik/core/net/outgoing/x;->n:Ljava/util/List;
    ...
    iget-boolean v0, p0, Lkik/core/net/outgoing/x;->b:Z
...
.method public final e()Lkik/core/net/outgoing/x;
    .locals 7
    ...
    iget-object v2, p0, Lkik/core/net/outgoing/x;->j:Ljava/lang/String;

    iget-boolean v3, p0, Lkik/core/net/outgoing/x;->a:Z

    iget-boolean v4, p0, Lkik/core/net/outgoing/x;->b:Z

    iget-object v5, p0, Lkik/core/net/outgoing/x;->l:Ljava/lang/String;

    iget-object v6, p0, Lkik/core/net/outgoing/x;->m:Ljava/lang/String;
    ...
    .line 142
    iget-object v1, p0, Lkik/core/net/outgoing/x;->n:Ljava/util/List;

    invoke-virtual {v0, v1}, Lkik/core/net/outgoing/x;->a(Ljava/util/List;)V
