...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lrx/internal/operators/OperatorReplay;->e:Lrx/b/f;

    return-void
.end method

.method private constructor <init>(Lrx/c$a;Lrx/c;Ljava/util/concurrent/atomic/AtomicReference;Lrx/b/f;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .prologue
    .line 251
    invoke-direct {p0, p1}, Lrx/c/b;-><init>(Lrx/c$a;)V
    ...
    .line 254
    iput-object p4, p0, Lrx/internal/operators/OperatorReplay;->d:Lrx/b/f;

    .line 255
    return-void
.end method

.method public static a(Lrx/c;I)Lrx/c/b;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 1132
    sget-object v0, Lrx/internal/operators/OperatorReplay;->e:Lrx/b/f;

    invoke-static {p0, v0}, Lrx/internal/operators/OperatorReplay;->a(Lrx/c;Lrx/b/f;)Lrx/c/b;
...
.method public static a(Lrx/c;JLjava/util/concurrent/TimeUnit;Lrx/f;)Lrx/c/b;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static/range {v1 .. v6}, Lrx/internal/operators/OperatorReplay;->a(Lrx/c;JLjava/util/concurrent/TimeUnit;Lrx/f;I)Lrx/c/b;
...
.method public static a(Lrx/c;JLjava/util/concurrent/TimeUnit;Lrx/f;I)Lrx/c/b;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p0, v2}, Lrx/internal/operators/OperatorReplay;->a(Lrx/c;Lrx/b/f;)Lrx/c/b;
...
.method private static a(Lrx/c;Lrx/b/f;)Lrx/c/b;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {v1, v0, p1}, Lrx/internal/operators/OperatorReplay$4;-><init>(Ljava/util/concurrent/atomic/AtomicReference;Lrx/b/f;)V

    .line 246
    new-instance v2, Lrx/internal/operators/OperatorReplay;

    invoke-direct {v2, v1, p0, v0, p1}, Lrx/internal/operators/OperatorReplay;-><init>(Lrx/c$a;Lrx/c;Ljava/util/concurrent/atomic/AtomicReference;Lrx/b/f;)V

    return-object v2
.end method

.method public static d(Lrx/c;)Lrx/c/b;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public final c(Lrx/b/b;)V
    ...
    iget-object v1, p0, Lrx/internal/operators/OperatorReplay;->d:Lrx/b/f;
