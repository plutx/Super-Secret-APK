...
.field private h:Llynx/bliss/widget/BubbleShapedDrawable$ArrowLocation;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 19
    sget-object v0, Llynx/bliss/widget/BubbleShapedDrawable$ArrowLocation;->ARROW_NONE:Llynx/bliss/widget/BubbleShapedDrawable$ArrowLocation;

    iput-object v0, p0, Lcom/kik/cache/ContentPreviewImageView;->h:Llynx/bliss/widget/BubbleShapedDrawable$ArrowLocation;
...
.method protected a(Landroid/graphics/Bitmap;Ljava/lang/String;)Llynx/bliss/widget/ai;
    ...
    invoke-direct {v0, p1, v1}, Llynx/bliss/widget/bp;-><init>(Landroid/graphics/Bitmap;Ljava/lang/String;)V
    ...
    .line 60
    :cond_0
    new-instance v0, Llynx/bliss/widget/BubbleShapedDrawable;

    iget-object v1, p0, Lcom/kik/cache/ContentPreviewImageView;->h:Llynx/bliss/widget/BubbleShapedDrawable$ArrowLocation;

    invoke-direct {v0, p1, v1}, Llynx/bliss/widget/BubbleShapedDrawable;-><init>(Landroid/graphics/Bitmap;Llynx/bliss/widget/BubbleShapedDrawable$ArrowLocation;)V
    ...
    invoke-virtual {v0, v1, v2}, Llynx/bliss/widget/BubbleShapedDrawable;->a(II)V

    .line 62
    iget-object v1, p0, Lcom/kik/cache/ContentPreviewImageView;->a:Landroid/graphics/Point;

    invoke-virtual {v0, v1}, Llynx/bliss/widget/BubbleShapedDrawable;->a(Landroid/graphics/Point;)V

    .line 63
    iget v1, p0, Lcom/kik/cache/ContentPreviewImageView;->d:I

    invoke-virtual {v0, v1}, Llynx/bliss/widget/BubbleShapedDrawable;->a(I)V
...
.method protected final b(Landroid/graphics/Bitmap;)V
    ...
    .prologue
    .line 43
    invoke-super {p0, p1}, Llynx/bliss/widget/KikNetworkedImageView;->b(Landroid/graphics/Bitmap;)V
...
.method protected final c(Landroid/graphics/Bitmap;)V
    ...
    .prologue
    .line 49
    invoke-super {p0, p1}, Llynx/bliss/widget/KikNetworkedImageView;->c(Landroid/graphics/Bitmap;)V
