.class public final Llynx/bliss/util/ch;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Llynx/bliss/util/ch$a;,
        Llynx/bliss/util/ch$c;,
        Llynx/bliss/util/ch$d;,
        Llynx/bliss/util/ch$b;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Llynx/bliss/util/ch;->a:Ljava/lang/String;
...
.method public static a(Landroid/view/View;ILandroid/animation/ValueAnimator$AnimatorUpdateListener;Landroid/animation/Animator$AnimatorListener;JJ)Landroid/animation/Animator;
    ...
    .line 818
    invoke-static {p0, p2}, Llynx/bliss/util/ch;->a(Landroid/view/View;Landroid/animation/ValueAnimator$AnimatorUpdateListener;)Landroid/animation/ValueAnimator$AnimatorUpdateListener;
...
.method private static a(Landroid/view/View;Landroid/animation/ValueAnimator$AnimatorUpdateListener;)Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    .line 884
    invoke-static {v0, p0, p1}, Llynx/bliss/util/cj;->a(Landroid/view/ViewGroup$MarginLayoutParams;Landroid/view/View;Landroid/animation/ValueAnimator$AnimatorUpdateListener;)Landroid/animation/ValueAnimator$AnimatorUpdateListener;
...
.method public static a(Landroid/view/View;ILandroid/animation/AnimatorListenerAdapter;)Landroid/animation/ValueAnimator;
    ...
    .line 854
    invoke-static {p0, p1, v0, v0}, Llynx/bliss/util/ch;->a(Landroid/view/View;ILandroid/animation/ValueAnimator$AnimatorUpdateListener;Landroid/animation/Animator$AnimatorListener;)Landroid/animation/ValueAnimator;
...
.method public static a(Landroid/view/View;)Llynx/bliss/util/ch$b;
    .locals 2

    .prologue
    .line 279
    new-instance v0, Llynx/bliss/util/ch$b;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Llynx/bliss/util/ch$b;-><init>(Landroid/view/View;B)V

    return-object v0
.end method

.method public static a(Lkik/core/datatypes/messageExtensions/ContentMessage;Landroid/content/Context;Ljava/lang/String;)Llynx/bliss/util/ch$c;
    .locals 9
    ...
    invoke-static {p1, v0}, Llynx/bliss/util/DeviceUtils;->a(Landroid/content/Context;Ljava/lang/String;)Z

    move-result v3

    if-eqz v3, :cond_5

    sget-object v3, Llynx/bliss/util/ch;->a:Ljava/lang/String;
    ...
    invoke-static {p0}, Llynx/bliss/util/p;->a(Lkik/core/datatypes/messageExtensions/ContentMessage;)Ljava/lang/String;
    ...
    invoke-static {v0}, Llynx/bliss/util/ch;->a(Lkik/core/datatypes/r;)Landroid/graphics/Bitmap;
    ...
    .line 419
    :cond_9
    new-instance v2, Llynx/bliss/util/ch$c;

    invoke-direct {v2, v1, v3, v0, v4}, Llynx/bliss/util/ch$c;-><init>(Ljava/lang/String;Ljava/lang/String;Landroid/graphics/Bitmap;Lcom/kik/contentlink/model/attachments/ContentUri;)V
...
.method public static a(Landroid/view/View;Landroid/animation/AnimatorListenerAdapter;)V
    ...
    invoke-static {p0, v0, v1, p1}, Llynx/bliss/util/ch;->a(Landroid/view/View;ILandroid/animation/ValueAnimator$AnimatorUpdateListener;Landroid/animation/Animator$AnimatorListener;)Landroid/animation/ValueAnimator;
    ...
    .line 2841
    new-instance v1, Llynx/bliss/util/ch$2;

    invoke-direct {v1, p0}, Llynx/bliss/util/ch$2;-><init>(Landroid/view/View;)V
...
.method public static a(Landroid/widget/EditText;)V
    ...
    new-instance v2, Llynx/bliss/util/bz$a;

    invoke-direct {v2}, Llynx/bliss/util/bz$a;-><init>()V
...
.method public static a(Landroid/widget/ScrollView;)V
    ...
    .line 2719
    new-instance v0, Llynx/bliss/util/ch$1;

    invoke-direct {v0, p0}, Llynx/bliss/util/ch$1;-><init>(Landroid/widget/ScrollView;)V
...
.method public static b(Landroid/view/View;I)V
    ...
    invoke-virtual {v0, p1}, Llynx/bliss/util/ch$b;->a(I)Llynx/bliss/util/ch$b;
...
.method static synthetic b(Landroid/view/View;ILandroid/animation/ValueAnimator$AnimatorUpdateListener;Landroid/animation/Animator$AnimatorListener;JJ)V
    ...
    .line 0
    .line 3808
    invoke-static/range {p0 .. p7}, Llynx/bliss/util/ch;->a(Landroid/view/View;ILandroid/animation/ValueAnimator$AnimatorUpdateListener;Landroid/animation/Animator$AnimatorListener;JJ)Landroid/animation/Animator;
...
.method public static c(Landroid/view/View;I)V
    ...
    .line 539
    invoke-static {p0, v0, v1, v2, v3}, Llynx/bliss/util/ch;->a(Landroid/view/View;IIII)V
...
.method public static d(Landroid/view/View;)V
    ...
    .line 3073
    :cond_4
    invoke-static {v0, v3}, Llynx/bliss/util/ch;->e(Landroid/view/View;I)V
    ...
    invoke-virtual {v0}, Llynx/bliss/util/ch$b;->a()Llynx/bliss/util/ch$b;

    move-result-object v0

    invoke-virtual {v0, v3}, Llynx/bliss/util/ch$b;->a(I)Llynx/bliss/util/ch$b;
    ...
    invoke-virtual {v0, v3}, Llynx/bliss/util/ch$b;->c(I)Llynx/bliss/util/ch$b;
...
.method public static f(Landroid/view/View;I)V
    ...
    .line 808
    invoke-static {p0, p1}, Llynx/bliss/util/ci;->a(Landroid/view/View;I)Ljava/lang/Runnable;
