...
.field private b:Lkik/core/manager/ah;
...
.field private c:Lkik/core/manager/ah;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lkik/core/manager/ah",
            "<",
...
.field private d:Lkik/core/manager/ah;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lkik/core/manager/ah",
            "<",
...
.method private constructor <init>(Lokhttp3/u;Ljava/lang/String;)V
    ...
    .line 41
    invoke-static {}, Lkik/core/datatypes/c;->h()Lcom/google/gson/d;
    ...
    invoke-direct {v0, v2, v1}, Lkik/core/manager/ah;-><init>(ILrx/c$c;)V

    iput-object v0, p0, Lkik/core/manager/BotSearchNetworkProvider;->c:Lkik/core/manager/ah;
    ...
    iput-object v0, p0, Lkik/core/manager/BotSearchNetworkProvider;->b:Lkik/core/manager/ah;
    ...
    invoke-direct {v0, v1, v2}, Lkik/core/manager/ah;-><init>(ILrx/c$c;)V

    iput-object v0, p0, Lkik/core/manager/BotSearchNetworkProvider;->d:Lkik/core/manager/ah;
...
.method static synthetic a(Lkik/core/manager/BotSearchNetworkProvider;Lrx/c;)Lrx/c;
    ...
    invoke-static {v0}, Lkik/core/manager/f;->a(Lkik/core/manager/BotSearchNetworkProvider$BotService;)Lrx/b/g;

    move-result-object v0

    invoke-virtual {p1, v0}, Lrx/c;->c(Lrx/b/g;)Lrx/c;
    ...
    .line 1046
    invoke-interface {v1}, Lkik/core/manager/ao;->a()Lrx/c$c;
...
.method static synthetic b(Lkik/core/manager/BotSearchNetworkProvider;Lrx/c;)Lrx/c;
    ...
    invoke-static {v0}, Lkik/core/manager/e;->a(Lkik/core/manager/BotSearchNetworkProvider$BotService;)Lrx/b/g;
...
.method static synthetic c(Lkik/core/manager/BotSearchNetworkProvider;Lrx/c;)Lrx/c;
    ...
    invoke-static {v0}, Lkik/core/manager/d;->a(Lkik/core/manager/BotSearchNetworkProvider$BotService;)Lrx/b/g;
...
.method public final a(Ljava/lang/String;)Lrx/c;
    ...
    .prologue
    .line 58
    iget-object v0, p0, Lkik/core/manager/BotSearchNetworkProvider;->b:Lkik/core/manager/ah;

    invoke-virtual {v0, p1}, Lkik/core/manager/ah;->a(Ljava/lang/Object;)Lrx/c;
...
.method public final b(Ljava/lang/String;)Lrx/c;
    ...
    .prologue
    .line 64
    iget-object v0, p0, Lkik/core/manager/BotSearchNetworkProvider;->c:Lkik/core/manager/ah;
...
.method public final c(Ljava/lang/String;)Lrx/c;
    ...
    .prologue
    .line 69
    iget-object v0, p0, Lkik/core/manager/BotSearchNetworkProvider;->d:Lkik/core/manager/ah;
